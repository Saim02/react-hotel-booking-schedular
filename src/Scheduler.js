...
import { AppstoreAddOutlined } from "antd/lib/icon";
...
class Scheduler extends Component {
  ...
  static propTypes = {
    ...
    demoFunc: PropTypes.func,
    setResourceManageModal: PropTypes.func,
  ...
  render() {
    ...
    if (showAgenda) {
      ...
      if (schedulerData.viewType === ViewTypes.Week) {
        if (config.schedulerMaxHeight > 0) {
          schedulerContentStyle = {
            ...schedulerContentStyle,
            maxHeight:
              config.schedulerMaxHeight - config.tableHeaderHeight - 70,
          };
      ...
      let resourceName = schedulerData.isEventPerspective ? (
        ...
        >
          ...
          >
            {/* {leftCustomHeader} */}
            <SideMenuBar addResource={this.props.addResource} />
          ...
          <div
            ...
            onClick={() => {
              ...
              newEvent(
                ...
                "r2",
                "St(2)",
                moment().format(DATE_FORMAT) + " 12:01:01",
                moment().add(1, "days").format(DATE_FORMAT) + " 12:01:01",
                1,
                undefined
              );
            }}
          >
            <TiPlus color="white" size={25} />
          </div>
        </div>
      );
      tbodyContent = (
        ...
        >
          ...
          >
            <SearchReservations
              ...
              setEventDetails={this.props.setEventDetails}
            />
          </Col>
          <Col>
    ...
    let schedularFooter = (
      <tr style={{ height: config.nonAgendaSlotMinHeight }}>
        <td
          style={{
        ...
        <Modal
          ...
          footer={false}
          title="LEGEND"
          onCancel={(val) => this.setState({ showLegend: false })}
        >
          <img width="100%" alt="Displying" src={legendImage} />
        </Modal>
      </tr>
    );
    ...
    return (
      ...
      >
        ...
        <tfoot id="schedular-footer">{schedularFooter}</tfoot>
      </table>
    );
  }
